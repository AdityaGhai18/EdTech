...
/**
 * Updated menuGroups reflecting Kipu's user flows:
 * - Dashboard (overview)
 * - Deposit
 * - Transfer
 * - Withdraw
 * - Transaction History
 * - Settings, Profile, Help (under OTHERS)
 */
const menuGroups = [
  {
    name: "MAIN MENU",
      ...
      },
      {
        icon: (
          ...
          >
            ...
            <path
              d="M3 6.25C3 5.84 3.34 5.5 3.75 5.5H13.75C14.16 5.5 14.5 5.84 14.5 6.25C14.5 6.66 14.16 7 13.75 7H3.75C3.34 7 3 6.66 3 6.25Z"
              fill=""
            />
            <path
              d="M3 12.25C3 11.84 3.34 11.5 3.75 11.5H10.75C11.16 11.5 11.5 11.84 11.5 12.25C11.5 12.66 11.16 13 10.75 13H3.75C3.34 13 3 12.66 3 12.25Z"
              fill=""
            />
          </svg>
        ),
        ...
        icon: (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M17 14C17.55 14 18 13.55 18 13C18 12.45 17.55 12 17 12C16.45 12 16 12.45 16 13C16 13.55 16.45 14 17 14Z"
              fill=""
            />
            <path
              d="M2.75 12C2.75 11.58 3.09 11.25 3.5 11.25H10.5C10.91 11.25 11.25 11.58 11.25 12C11.25 12.41 10.91 12.75 10.5 12.75H3.5C3.09 12.75 2.75 12.41 2.75 12Z"
              fill=""
            />
          </svg>
        ),
      ...
      },
      {
        icon: (
          ...
          >
            {/* Placeholder Icon Path */}
            <path
              d="M18.29 4.89C17.26 4.75 15.91 4.75 14 4.75H10C8.09 4.75 6.74 4.75 5.71 4.89C4.71 5.02 4.13 5.28 3.7 5.70C3.28 6.12 3.02 6.70 2.89 7.71C2.75 8.74 2.75 10.09 2.75 12C2.75 13.91 2.75 15.26 2.89 16.29C3.02 17.30 3.28 17.88 3.70 18.30C4.13 18.72 4.71 18.98 5.71 19.11C6.74 19.25 8.09 19.25 10 19.25H14C15.91 19.25 17.26 19.25 18.29 19.11C19.29 18.98 19.87 18.72 20.30 18.30C20.72 17.88 20.98 17.30 21.11 16.29C21.25 15.26 21.25 13.91 21.25 12C21.25 10.09 21.25 8.74 21.11 7.71C20.98 6.70 20.72 6.12 20.30 5.70C19.87 5.28 19.29 5.02 18.29 4.89ZM12 16.25C12.41 16.25 12.75 16.59 12.75 17C12.75 17.41 12.41 17.75 12 17.75H9C8.59 17.75 8.25 17.41 8.25 17C8.25 16.59 8.59 16.25 9 16.25H12Z"
              fill=""
            />
          </svg>
        ),
        ...
        icon: (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 12C2 11.59 2.34 11.25 2.75 11.25H10.75C11.16 11.25 11.5 11.59 11.5 12C11.5 12.41 11.16 12.75 10.75 12.75H2.75C2.34 12.75 2 12.41 2 12ZM13.25 12C13.25 11.59 13.59 11.25 14 11.25H21.25C21.66 11.25 22 11.59 22 12C22 12.41 21.66 12.75 21.25 12.75H14C13.59 12.75 13.25 12.41 13.25 12Z"
              fill=""
            />
            <path
              d="M9 8.25C9.41 8.25 9.75 8.59 9.75 9C9.75 9.41 9.41 9.75 9 9.75H3.75C3.34 9.75 3 9.41 3 9C3 8.59 3.34 8.25 3.75 8.25H9Z"
              fill=""
            />
            <path
              d="M21 15C21 15.41 20.66 15.75 20.25 15.75H14.75C14.34 15.75 14 15.41 14 15C14 14.59 14.34 14.25 14.75 14.25H20.25C20.66 14.25 21 14.59 21 15Z"
              fill=""
            />
          </svg>
        ),
      ...
      },
      {
        icon: (
          ...
          >
            {/* Placeholder Icon Path */}
            <path
              d="M14.9453 1.25C13.58 1.25 12.48 1.25 11.61 1.37C10.71 1.49 9.95 1.75 9.35 2.35C8.82 2.88 8.56 3.52 8.42 4.28C8.28 5.01 8.25 5.91 8.25 7C8.25 7.41 8.59 7.75 9 7.75C9.41 7.75 9.75 7.41 9.75 7C9.75 5.91 9.78 5.14 9.89 4.55C9.99 3.98 10.17 3.65 10.41 3.41C10.69 3.13 11.07 2.95 11.81 2.85C12.56 2.75 13.56 2.75 15 2.75H16C17.44 2.75 18.44 2.75 19.19 2.85C19.93 2.95 20.31 3.13 20.59 3.41C20.87 3.69 21.05 4.07 21.15 4.81C21.25 5.56 21.25 6.56 21.25 8V16C21.25 17.44 21.25 18.44 21.15 19.19C21.05 19.93 20.87 20.31 20.59 20.59C20.31 20.87 19.93 21.05 19.19 21.15C18.44 21.25 17.44 21.25 16 21.25H15C13.56 21.25 12.56 21.25 11.81 21.15C11.07 21.05 10.69 20.87 10.41 20.59C10.17 20.35 9.99 20.02 9.89 19.45C9.78 18.86 9.75 18.09 9.75 17C9.75 16.59 9.41 16.25 9 16.25C8.59 16.25 8.25 16.59 8.25 17C8.25 18.09 8.28 18.99 8.42 19.72C8.56 20.48 8.82 21.12 9.35 21.65C9.95 22.25 10.71 22.51 11.61 22.63C12.48 22.75 13.58 22.75 14.95 22.75H16.06C17.42 22.75 18.52 22.75 19.39 22.63C20.29 22.51 21.05 22.25 21.65 21.65C22.25 21.05 22.51 20.29 22.63 19.39C22.75 18.52 22.75 17.42 22.75 16.06V7.94C22.75 6.58 22.75 5.48 22.63 4.61C22.51 3.71 22.25 2.95 21.65 2.35C21.05 1.75 20.29 1.49 19.39 1.37C18.52 1.25 17.42 1.25 16.06 1.25H14.95Z"
              fill=""
            />
            <path
              d="M2 11.249C1.59 11.249 1.25 11.58 1.25 11.999C1.25 12.41 1.59 12.75 2 12.75H8.98L7.01 14.43C6.7 14.70 6.66 15.17 6.93 15.48C7.20 15.80 7.67 15.84 7.98 15.57L11.48 12.57C11.65 12.42 11.75 12.22 11.75 11.999C11.75 11.78 11.65 11.58 11.48 11.43L7.98 8.43C7.67 8.16 7.20 8.20 6.93 8.51C6.66 8.82 6.70 9.29 7.01 9.56L8.98 11.249H2Z"
              fill=""
            />
          </svg>
        ),
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/">
            {/* Update these logos to Kipu brand assets if available */}
            <Image
              width={176}
              height={32}
